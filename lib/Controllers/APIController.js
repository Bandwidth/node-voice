...
class APIController {
            ...
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    const mappedObject = _baseController.getObjectMapper()
                        .mapObject(response, 'ApiErrorResponseException');
                    mappedObject.reason = 'Something\'s not quite right... Either your request is invalid or you\'re requesting it at a bad time. Please fix it before trying again.';
                    mappedObject.context = _context;
                    const _err = { errorMessage: 'Something\'s not quite right... Either your request is invalid or you\'re requesting it at a bad time. Please fix it before trying again.',
                        errorCode: 400,
     ...
     * @returns {Promise}
     */
    static getQueryMetadataForAccountAndCall(accountId,
        callId,
        from,
        to,
        minStartTime,
